...
export default {
  ...
  data() {
    return {
      ...
      posters: [
        {
          src: require("@/assets/images/activities/haibao_1.png"),
          style: "color:#fc3941;top:2.65rem;",
          icstyle: ""
        },
        {
          src: require("@/assets/images/activities/haibao_2.png"),
          style: "color:#fff;top:2.95rem;",
          icstyle: ""
        },
        {
          src: require("@/assets/images/activities/haibao_3.png"),
          style: "color:#fff;top:2.55rem;",
          icstyle: ""
        },
        {
          src: require("@/assets/images/activities/haibao_4.png"),
          style: "color:#fff;top:2.8rem;",
          icstyle: ""
        },
        {
          src: require("@/assets/images/activities/haibao_5.png"),
          style: "color:#fff;top:2.75rem;",
          icstyle: ""
        },
        {
          src: require("@/assets/images/activities/haibao_6.png"),
      ...
      postersActive: [
        {
          src: require("@/assets/images/activities/haibao_s1.png"),
          active: true
        },
        {
          src: require("@/assets/images/activities/haibao_s2.png"),
          active: false
        },
        {
          src: require("@/assets/images/activities/haibao_s3.png"),
          active: false
        },
        {
          src: require("@/assets/images/activities/haibao_s4.png"),
          active: false
        },
        {
          src: require("@/assets/images/activities/haibao_s5.png"),
          active: false
        },
        {
          src: require("@/assets/images/activities/haibao_s6.png"),
          active: false
        }
      ]
    };
    ...
    ul {
      ...
      li {
        ...
        i {
          position: absolute;
          margin: auto;
          background-image: url("../../../assets/images/activities/haibao_ok.png");
          background-size: 100%;
          width: 0.4rem;
          height: 0.4rem;
          top: 0;
