    ...
    return {
      ...
      faq_new: [
        {
          ask: "1.超级头条是什么？",
          answer:
            "平台致力于打造一款新形式的资讯阅读软件，以移动应用为载体进行内容创作、资讯阅读、提供更多有用有趣、有益、的内容给大家。",
          show: false,
          iosshow: true
        },
        {
          ask: "2.邀请好友的好处？",
          answer:
            "邀请好友能让您的收益迅速增加，现在邀请好友在该平台进行注册，每邀请一位有效好友奖励18200金币，首次邀请好友还额外奖励1元红包哦~，满足平台提现规则后方可进行申请提现。邀请好友越多，收益越多。",
          show: false,
          iosshow: true
        },
        {
      ...
      faq_invite: [
        ...
        },
        {
          ...
          answer:
            "平台对于进贡机制管理非常严格，对阅读质量要求更高，只有当徒弟，的阅读对平台产生价值的情况下才会有进贡奖励，因此徒弟的阅读有一部分没有进贡也是正常的。",
          show: false,
          iosshow: true
        },
        {
          ...
          answer:
            "如果您分享后海报的好友看不到，请重新分享一次给好友，最新的可以正常看到。（如果多次尝试失败，您可以在“我的”页面通过【在线客服】获得帮助）。",
          show: false,
          iosshow: true
        }
      ],
      faq_tixian: [
        {
          ask: "1.如何支付宝提现？",
          answer:
            "当您的零钱达到平台30元，即可进入“我的”页面-->“兑换提现”一栏，点击进入后可以看到支付宝100/50/30元红包（选择前请再三确认提现支付宝仍在正常使用）。",
          show: false,
          iosshow: true
        },
        {
  ...
  methods: {
    ...
    async Alert() {
      ...
      if (rs && rs.code === 1001 && rs.data) {
        ...
        this.$confirm(
          '<div style="color:#999">请您添加官方' +
            this.weqq +
            '客服</div><div style="color:#a30c0c">' +
            this.weNum +
...
.faq {
  ...
  .faq_nav {
    ...
    position: fixed;
    top: 1.2rem;
    box-shadow: 0.02rem 0.02rem 0.05rem #eee;
    li {
      width: 1.8rem;
      line-height: 0.6rem;
      text-align: center;
