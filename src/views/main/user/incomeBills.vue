  ...
  <div class="income">
    ...
    <div class="incomeBills" v-show="!loading">
      <router-link to="/ranking" v-show="!iospedding">
        ...
        <a href="../../views/main/home.html#/faq" v-show="!iospedding">
      ...
      <div class="incomeBills_fixbtn" v-show="!iospedding">
        <button @click="shareIncome">累计收入{{detail.accumulate_cash | decimal}}<span></span>每天晒收入送100金币</button>
      </div>
    </div>
  </div>
</template>
...
.torank {
  height: 1.2rem;
  cursor: pointer;
  background-image: url("../../../assets/images/torank.png");
