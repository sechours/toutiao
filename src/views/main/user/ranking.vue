  ...
  .rank_bg {
    ...
    .top {
      ...
      .week {
        width: 3.23rem;
        height: 1.02rem;
        background: url("../../../assets/images/activities/rank_week.png")
      ...
      .total {
        width: 3.23rem;
        height: 1.02rem;
        background: url("../../../assets/images/activities/rank_total.png")
          no-repeat center center;
        background-size: 100%;
        text-align: center;
        font-size: 0.48rem;
          ...
          table {
            ...
            td {
              ...
              &.rank {
                color: #ffcb11;
                &.one {
                  background: url("../../../assets/images/activities/rank_one.png")
                    no-repeat center center;
                  background-size: 0.6rem;
                  color: #fff;
                }
                &.two {
                  background: url("../../../assets/images/activities/rank_two.png")
                    no-repeat center center;
                  background-size: 0.6rem;
                  color: #fff;
                }
                &.three {
                  background: url("../../../assets/images/activities/rank_three.png")
                    no-repeat center center;
                  background-size: 0.6rem;
                  color: #fff;
                }
