...
export default {
  ...
  methods: {
    ...
    goshai() {
      appcall.navigator({
        title: "晒收入",
        url: this.$h5url + "/activities/shareIncome.html"
      });
    },
    /**
     * 去任务中心
    ...
    toactivity() {
      appcall.navigator({
        title: "新年小目标",
        url: this.$h5url + "/activities/sendcrash.html"
      });
    },
    /**
     * 展示/隐藏规则
...
.invitepupil {
    ...
    .txt2 {
      ...
      .btn {
        ...
        button {
          ...
          width: 1.74rem;
          height: 0.65rem;
          background: url(../../../assets/images/td_role.png) no-repeat center
            center;
          background-size: 100%;
          text-align: center;
          left: 0.2rem;
  ...
  .pop {
    ...
    .rolebg {
      ...
      .tt {
        ...
        height: 0.51rem;
        margin: 0 auto;
        background: url(../../../assets/images/pop_td_tt.png) no-repeat center
          center;
        background-size: 100%;
      }
      .txt1 {
      ...
      .tt2 {
        ...
        height: 0.5rem;
        margin: 0 auto;
        background: url(../../../assets/images/pop_td_jiangli.png) no-repeat
          center center;
        background-size: 100%;
        color: #fff;
        text-align: center;
    ...
    .rolebg {
      ...
      .txt2 {
        .ico {
          width: 1.4rem;
          height: 2.2rem;
          background: url(../../../assets/images/pop_td_yuanxiao.png) no-repeat
            center center;
          background-size: 100%;
          margin: 0.4rem 0.3rem 0 0.2rem;
          float: left;
        }
        .content {
          font-size: 0.26rem;
      ...
      li.table {
        ...
        .position {
          ...
          &.one {
            color: #fff;
            font-size: 0.25rem;
            background: url(../../../assets/images/td_one.png) no-repeat center
              center;
          ...
          &.two {
            color: #fff;
            font-size: 0.25rem;
            background: url(../../../assets/images/td_two.png) no-repeat center
              center;
            background-size: 0.4rem 0.44rem;
            vertical-align: top;
          }
          &.three {
            color: #fff;
            font-size: 0.25rem;
            background: url(../../../assets/images/td_three.png) no-repeat
              center center;
            background-size: 0.4rem 0.44rem;
            vertical-align: top;
          }
  ...
  .shuom_tip {
    ...
    height: 2.28rem;
    text-align: center;
    background: url(../../../assets/images/wake_sm.png) no-repeat center center;
    background-size: 100%;
  }
  .shuom {
    width: 100vw;
    ...
    .shuombg {
      ...
      &:before {
        ...
        height: 0.93rem;
        width: 100%;
        background: url("../../../assets/images/wake_sm_tp.png") no-repeat
          center center;
